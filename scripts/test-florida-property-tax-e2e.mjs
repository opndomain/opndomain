...
/**
 * test-florida-property-tax-e2e.mjs â€” E2E debate: "Should Florida eliminate
 * property taxes for homesteaded residents?"
 *
 * 5 agents drive the full debate lifecycle:
...
const CONTRIBUTION_TEMPLATES = {
  ...
  synthesize: {
    ...
    housing_economist:
      "The debate converged on the circuit breaker as the synthesis position, and I want to explain why this is economically superior to both the status quo and full elimination. The status quo taxes unrealized appreciation, creating liquidity crises for asset-rich, income-poor homeowners â€” a market failure. Full elimination capitalizes the tax savings into home prices, creates a two-tier property market, and destroys $25 billion in local revenue â€” a policy failure. The circuit breaker threads the needle: it preserves the property tax's efficiency benefits (taxing land value, funding local services proportionally) while capping the burden at a payable percentage of actual income. The estimated cost of $3-5 billion annually is roughly 12-20% of current homestead property tax revenue â€” significant but manageable through tourism tax expansion without structural disruption to local budgets.",
    populist_advocate:
      "I came to this debate as an advocate for full elimination, and I'm leaving as an advocate for a generous circuit breaker â€” not because my principles changed but because the debate showed me a faster path to the same goal: protecting homeowners from being taxed out of their homes. The circuit breaker at 4% of income solves the most acute cases immediately. My retired teacher in Tampa sees her bill drop from $4,800 to $1,280 â€” a $3,520 annual savings that keeps her in her home. The broader principle remains: a society that taxes people on wealth they can't access without losing their shelter has a moral problem. The circuit breaker is the pragmatic solution; full elimination remains the aspirational one. I'd support the circuit breaker as legislation this session while continuing to advocate for the longer-term goal.",
    public_finance:
      "This debate produced a genuine policy consensus from opposing starting positions â€” which is rare in tax policy. The synthesis: Florida should implement an income-based circuit breaker capping homestead property taxes at 4% of household income, funded by state reimbursement to counties through a 1.5% statewide tourism tax increase. This addresses three separate legitimate concerns: (1) the fiscal conservative's objection to taxing illiquid wealth, (2) the municipal realist's requirement for revenue certainty, and (3) the economist's caution against destroying the property tax's efficiency benefits. The remaining disagreement â€” whether this is the endpoint or a step toward full elimination â€” is a values question about the proper scope of property taxation that this policy debate cannot and should not try to resolve. The circuit breaker is good policy regardless of which side of that question you fall on.",
  },
  predict: {
    fiscal_conservative:
      "I predict Florida will pass some form of property tax relief expansion within the next two legislative sessions (by 2028). The political dynamics are aligned: Governor DeSantis and the legislature are competing to be the most tax-friendly state, and property tax relief polls above 70% among Florida voters regardless of party. The circuit breaker model has the best chance of passage because it has bipartisan appeal â€” fiscal conservatives like the tax reduction, progressives like the income-based targeting. Whether it reaches the 4% cap this debate converged on or starts more modestly at 5-6% is a political negotiation question. Confidence: 75% that some form of income-linked property tax relief passes by 2028; 40% that it reaches the full circuit breaker model we discussed.",
    municipal_realist:
      "I predict the policy debate will happen but the implementation will be harder than anyone in this discussion acknowledged. The biggest obstacle isn't political will â€” it's the Florida Constitution. Article VII Section 9 gives counties the power to levy property taxes, and any state-mandated circuit breaker that reduces county revenue requires either a constitutional amendment (60% voter approval) or a funded state mandate (which requires sustainable state revenue). I predict a watered-down version passes â€” probably an expanded homestead exemption to $100,000 rather than a true circuit breaker â€” because it's constitutionally simpler and politically easier. Confidence: 60% on expanded exemption by 2028; 25% on a true income-linked circuit breaker within 5 years.",
    housing_economist:
      "I predict that Florida's housing market dynamics will force this issue faster than the normal legislative timeline. Home prices in Florida have appreciated 58% since 2019, and even with Save Our Homes caps, property tax bills are rising 3% annually on a rapidly rising base. By 2028, the median homesteaded property tax bill in South Florida counties will exceed $6,000 â€” a level that creates political pressure even among middle-income homeowners who don't currently see themselves as burdened. The policy window will open when the constituency of affected homeowners expands beyond retirees to include working families. Confidence: 70% that property tax reform becomes a top-3 legislative priority by 2029; 50% that the reform includes an income-linked component rather than just exemption expansion.",
    populist_advocate:
      "My prediction is grounded in what I see at the grassroots level: property tax anger in Florida is intensifying faster than policymakers realize. The Facebook groups, the county commission meetings, the letters to state representatives â€” the volume has tripled since 2022. Senior advocacy organizations (AARP Florida, Silver-Haired Legislature) are already drafting model circuit breaker legislation. I predict a citizen-initiated constitutional amendment for property tax reform will qualify for the 2028 ballot if the legislature doesn't act first. Florida's initiative process requires 891,589 signatures â€” aggressive but achievable for an issue with 70%+ popular support. Confidence: 65% on ballot initiative qualification; 80% that the legislature acts preemptively with some form of expanded relief to avoid a more radical citizen initiative.",
    public_finance:
      "My meta-prediction: Florida's property tax debate will become a national model regardless of the specific outcome. As housing appreciation drives property tax burdens higher in Sun Belt states (Texas, Arizona, Nevada, Georgia), the policy frameworks developed in Florida â€” whether circuit breakers, expanded exemptions, or something else â€” will be adopted by other states facing the same pressures. The interstate competition for retirees and remote workers makes property tax policy a growth variable in state economic strategy. I predict at least 5 states will adopt or expand income-linked property tax relief by 2032, with Florida as either the leader or the cautionary tale. Confidence: 75% on multi-state adoption; 60% that Florida leads rather than follows.",
  },
};
...
async function main() {
  ...
  const topic = await api("/v1/internal/topics", {
    ...
    body: {
      ...
      reason: "E2E test â€” Florida property tax elimination debate",
    },
