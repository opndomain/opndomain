...
/**
 * test-georgia-defense-e2e.mjs â€” E2E debate: "Is the 2021 Georgia Bulldogs defense
...
const CONTRIBUTION_TEMPLATES = {
  propose: {
    sabermetrician:
      "The 2021 Georgia Bulldogs defense is the most statistically dominant unit in modern college football history by virtually every advanced metric. They allowed 6.9 points per game during the regular season â€” the lowest since 1971 Michigan. Their EPA/play allowed of -0.38 was the best in the analytics era (since 2004). Their success rate allowed of 24.1% was a full 4 percentage points better than the next-best defense in the CFP era. They held opponents to 3.4 yards per play, the lowest figure in FBS since 2000. Their havoc rate of 27.3% led the nation. They posted 4 shutouts and allowed more than 17 points only once in the regular season (the SECCG loss to Alabama). When you stack these numbers against every defense since advanced metrics became available, no unit comes close across this many dimensions simultaneously.",
    oldschool:
      "I've been scouting defenses for 35 years, and while 2021 Georgia was exceptional, calling them the greatest ever requires ignoring some legendary units. The 1985 Bears held opponents to 12.4 points per game in the NFL â€” against professional offenses â€” and had the most dominant postseason run in football history (10 points allowed in 3 playoff games). The 2000 Ravens allowed 10.3 points per game with 4 shutouts in 16 games. In college, the 2011 Alabama defense held opponents to 8.2 points per game and dominated the BCS title game against LSU 21-0. What made those units special wasn't just statistics â€” it was the eye test. The 2021 Georgia defense was stacked with talent, but they also played in the SEC East, which was unusually weak that year. Missouri, South Carolina, and Vanderbilt were not the gauntlet that 'SEC schedule' implies.",
    eraadjuster:
  ...
  synthesize: {
    ...
    nflevaluator:
      "The debate refined the GOAT claim from a broad assertion to a precise, defensible thesis. The convergence of three independent lines of evidence â€” (1) best analytics-era defensive statistics, (2) highest era-adjusted suppression rate against elite offenses, (3) unprecedented NFL talent validation â€” makes the 2021 Georgia defense the most thoroughly documented case for defensive greatness in college football. The Contrarian's insistence on epistemological honesty improved the argument by forcing us to specify what we can and can't prove. My final position: Georgia 2021 is the greatest college defense we can prove with evidence, and the evidence is strong enough that a pre-analytics challenger would need to be extraordinarily dominant to plausibly surpass them.",
    contrarian:
      "I entered this debate arguing that the 'statistically greatest' claim was a framing choice. I leave it acknowledging that the refined version of the claim â€” greatest in the analytics era, measured by performance against elite offenses with era adjustment â€” is well-supported and honestly scoped. The debate's most productive move was the Old-School Scout's 'greatest measurable defense' framing, which the Sabermetrician and Era Adjuster built on rather than resisted. My synthesis: the question 'Is the 2021 Georgia defense statistically the greatest ever?' has a defensible 'yes' if you define 'statistically' as 'within the era of available statistics' and 'greatest' as 'most dominant relative to offensive environment.' Those qualifiers aren't weaknesses â€” they're what make the claim honest rather than hyperbolic.",
  },
  predict: {
    sabermetrician:
      "I predict that within 5 years, retrospective analytics models will further strengthen Georgia 2021's case as more sophisticated era-adjustment tools are developed. The current generation of college football analytics is still maturing â€” as models incorporate opponent-adjusted metrics, schedule strength corrections, and play-level data more rigorously, Georgia's defensive performance will likely look even more anomalous. I also predict no defense in the next decade will match their combined statistical profile, because the depth of NFL-caliber talent required is nearly impossible to assemble under current roster and NIL dynamics. Confidence: 70% that Georgia 2021 remains the analytics-era benchmark through 2035.",
    oldschool:
      "My prediction: Georgia 2021 will be remembered as the consensus greatest defense of the 2020s, but the 'greatest ever' debate will persist because football culture values narrative alongside statistics. Some future defense will put up comparable numbers in a single season and reignite the debate â€” probably within 10 years as defensive coaching adapts to the spread. But matching Georgia's combination of regular-season dominance, championship-game performance, and NFL draft output in a single season will be extraordinarily rare. Confidence: 60% that the debate persists; 80% that no defense matches the full package within 10 years.",
    eraadjuster:
      "I predict the era-adjustment methodology itself will become the lasting contribution of debates like this one. Within 5-10 years, college football analytics will adopt standardized era-adjusted defensive metrics â€” similar to how baseball adopted OPS+ and ERA+ â€” that will make cross-era comparisons routine rather than ad hoc. When that happens, Georgia 2021 will be the first team tested against the new standard, and I predict they'll hold up. The bigger prediction: the spread offense revolution will plateau, and defensive innovation will close the gap, meaning future defenses will post better raw numbers but not necessarily better era-adjusted numbers than Georgia 2021. Confidence: 65%.",
    nflevaluator:
      "I predict the NFL careers of Georgia's 2021 defensive players will be the final validator. If Travon Walker, Jordan Davis, and Nakobe Dean develop into Pro Bowl-caliber players by 2027, it will retroactively confirm that the statistical dominance wasn't scheme-dependent â€” it was talent executing at a historic level. Conversely, if multiple first-rounders bust, it will weaken the 'greatest ever' argument by suggesting the stats were inflated by coaching and scheme rather than generational talent. My prediction: at least 3 of the 5 first-round defensive picks will make a Pro Bowl by 2028, confirming the talent thesis. Confidence: 55% â€” NFL development is inherently uncertain.",
    contrarian:
      "My meta-prediction: 'greatest defense ever' debates will become more common and more rigorous as analytics penetrate college football culture. Georgia 2021 will be the benchmark case study â€” the first defense whose GOAT claim was evaluated with analytics-era tools and epistemological honesty about what can and can't be proven. The precedent this debate sets â€” scoping claims to measurable eras, using suppression rates over raw stats, and demanding convergent evidence â€” will improve future GOAT arguments across all sports. Confidence: 70% that the methodology matters more than the specific verdict in the long run.",
  },
};
...
async function main() {
  ...
  const topic = await api("/v1/internal/topics", {
    ...
    body: {
      ...
      reason: "E2E test â€” 2021 Georgia defense GOAT debate",
    },
