...
/**
 * test-tiger-woods-e2e.mjs — E2E debate: "Is Tiger Woods the best golfer ever?"
 *
 * 5 agents with distinct golf perspectives drive the full debate_v2 lifecycle:
...
const CONTRIBUTION_TEMPLATES = {
  ...
  critique: {
    statistician:
      "The Traditionalist's case for Nicklaus leans heavily on the 18 majors number, but this deserves scrutiny. Three of Nicklaus's majors came at the 1966, 1971, and 1980 PGA Championships when the strongest international players often skipped the event. Nicklaus's 19 runner-up finishes are cited as evidence of consistency, but several came in weak fields by modern standards — the 1960s British Open regularly had fewer than 100 entrants. The 'rivalry depth' argument also needs context: Palmer, Player, and Trevino combined for 24 majors across their careers. Tiger's contemporaries — Mickelson, Els, Singh, and the current generation — represent a comparable rivalry pool. And the Competitor's 'intimidation factor' argument, while colorful, is unfalsifiable anecdote, not evidence.",
    traditionalist:
      "The Statistician's era-adjusted models are precisely the kind of speculative overcorrection that muddles clear evidence. Tiger's 68.17 scoring average came with ProV1 balls, titanium drivers, manicured fairways, and ShotLink-optimized preparation. Nicklaus played with persimmon woods on courses that weren't groomed to modern standards. Adjusting for these differences introduces so many assumptions that the model's output reflects the modeler's priors more than reality. The Modernist correctly notes that equipment has compressed talent distribution — which means Tiger's dominance came partly from being an early adopter of modern fitness and technology, not from being proportionally better than Nicklaus was in his era. Also, the Competitor's 'intimidation' argument cuts both ways — Nicklaus was called the 'Golden Bear' and intimidated a generation of players too.",
    modernist:
      "Both the Statistician and Traditionalist are committing the same error: treating their preferred metric as objective while dismissing the other side's preferred metric as contextual. Major count is a context-dependent statistic (number of majors per year changed, field composition changed). Scoring average is a context-dependent statistic (equipment, course conditions, ball technology). Even strokes gained requires a reference field that itself changes over time. The Philosopher raises the right question — what are we actually measuring? — but then retreats into meta-analysis without offering a framework. I'd argue the most defensible comparison metric is 'dominance relative to contemporaries,' measured by win percentage and margin of victory against the top 10 players of each era. By this measure, Tiger's 1999-2008 decade and Nicklaus's 1962-1978 window are remarkably similar.",
    competitor:
      "The Statistician calls the intimidation factor 'unfalsifiable anecdote,' but that reveals a blind spot in purely statistical thinking. Sports aren't physics experiments — human psychology is part of the competition. We have extensive interview evidence: Ernie Els has said Tiger made him feel helpless. Sergio Garcia visibly wilted in Tiger's presence at the 1999 PGA. David Duval went from world #1 to nearly quitting the game partly because Tiger's dominance was psychologically crushing. The Traditionalist's claim that Nicklaus was equally intimidating doesn't hold up — Nicklaus inspired rivals to elevate their game (Watson at Turnberry, Trevino at Merion). Tiger made rivals shrink. That's a qualitative difference, not just anecdotal noise. Also, the Philosopher's framework question, while intellectually honest, is a dodge — at some point you have to make a judgment.",
    philosopher:
      "I want to push back on every response so far for sharing an unexamined assumption: that 'best golfer ever' is a coherent single-answer question. The Statistician, Traditionalist, and Competitor are each implicitly arguing for different definitions of 'best' while pretending they're answering the same question. The Modernist comes closest to seeing this but still assumes a unified ranking is possible if we just find the right metric. I'd argue the debate is more productive if we acknowledge it's a multi-dimensional comparison with no Pareto-optimal answer. Tiger is the best golfer ever *at peak performance dominance*. Nicklaus is the best golfer ever *at sustained major championship excellence*. Hogan is the best golfer ever *at mechanical precision*. These aren't competing claims — they're answers to different questions. The interesting debate is which dimension matters most, and that's a values question, not an empirical one.",
  },
  refine: {
    statistician:
      "Fair critique on the era-adjustment models — the Traditionalist is right that too many assumptions can make models reflect the modeler. Let me sharpen my case with less model-dependent evidence. Tiger's record in World Golf Championships — events with the strongest guaranteed fields — is 18 wins in 47 starts (38% win rate). No other player in WGC history exceeds 15%. This controls for field strength better than major count because WGCs guarantee top-50 world-ranked players. Tiger's head-to-head record against Nicklaus-era comparison players is also instructive: against Mickelson (a generational talent), Tiger led their direct matchup scoring by 0.7 strokes per round across 87 shared events. I'll concede the Philosopher's point that 'best ever' needs definition — but under any performance-based definition, Tiger's peak is historically unmatched.",
    traditionalist:
      "I'll concede the Statistician's WGC point — Tiger's dominance in guaranteed-field events is genuinely impressive and harder to dismiss on era grounds. But let me refine my position: the GOAT question shouldn't be about peak alone. Nicklaus's career arc — competing at the highest level for 25+ years, winning majors across four decades, and remaining competitive into his mid-40s — represents a different kind of greatness that peak-focused metrics systematically undervalue. Tiger's career has a distinct 'before and after' divided by injuries and 2009. His post-2013 major record (1 win in ~30 starts) shows how fragile peak dominance is. The 2019 Masters was remarkable precisely because it was so unexpected. If we're judging 'careers' rather than 'peaks,' Nicklaus's consistency-over-decades argument strengthens considerably.",
    modernist:
      "The Competitor's pushback on the psychology question is well-taken — I was too quick to bracket it as unmeasurable. Let me refine: sports psychologists have studied 'competitive pressure response' and Tiger's Sunday performance data supports the intimidation thesis quantitatively. Tiger's scoring differential between rounds 1-3 and round 4 when leading was -1.2 strokes (he got better under pressure), while the field average was +0.8. That's a 2.0-stroke swing on Sundays, which is enormous. Nicklaus showed a similar but smaller effect (+0.3 vs field's +0.9). So the 'Tiger Effect' may be partially measurable through opponents' Sunday scoring when Tiger was in contention vs. when he wasn't. I'd still argue the question is multidimensional per the Philosopher's point, but Tiger has the strongest case on the 'peak dominance' dimension and a competitive case on 'psychological impact.'",
    competitor:
      "I appreciate the Modernist quantifying the Sunday pressure differential — that's exactly the kind of bridge between anecdote and data that this debate needs. Let me also concede the Traditionalist's career longevity point: Nicklaus's ability to win the 1986 Masters at 46 is extraordinary and Tiger's body broke down in ways that cut his prime short. But I'd reframe this: Tiger's injuries came partly from the intensity with which he played — the violent swing speed, the aggressive course management, the refusal to play conservatively. Nicklaus preserved his body by playing a more measured game. Tiger traded longevity for a higher peak, which itself tells us something about his competitive nature. The 2019 Masters comeback, with a fused spine and at age 43, may be the single most impressive individual performance in golf history precisely because of how damaged his body was. That's not a weakness in the GOAT case — it's supporting evidence.",
    philosopher:
      "The debate has sharpened productively. I'll refine my position: I was right that 'best ever' is multidimensional, but I was too dismissive of the possibility of making a reasoned judgment across dimensions. The Statistician's WGC data, the Modernist's Sunday differential analysis, and the Competitor's reframing of injuries-as-intensity all point toward Tiger having the strongest single-dimension case (peak dominance) while Nicklaus has the strongest multi-decade case. I'll now argue that peak dominance *should* carry more weight in the GOAT debate because it's the hardest thing to achieve — many golfers sustain long careers, but only one golfer has ever had a 2000-like season. Rarity should count. By analogy: we consider a .400 batting season more remarkable than a 20-year .300 average, even though the latter represents more total value. Tiger's peak is golf's .400 season.",
  },
  synthesize: {
    statistician:
...
async function main() {
  ...
  const topic = await api("/v1/internal/topics", {
    ...
    body: {
      ...
      reason: "E2E test — Tiger Woods GOAT debate",
    },
    logRequest: true,
