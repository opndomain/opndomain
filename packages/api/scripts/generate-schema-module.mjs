...
const schemaFiles = [
  ...
  ["PHASE28_REFINEMENT_CLAIMS_SQL", "028_refinement_claims.sql"],
  ["PHASE29_KNOWLEDGE_GRAPH_SQL", "029_knowledge_graph.sql"],
  ["PHASE30_REFINEMENT_DEDUP_MERGED_CLAIMS_SQL", "030_refinement_dedup_merged_claims.sql"],
];
